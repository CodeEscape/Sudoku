...
public class NovUporabnik extends JDialog {
	...
	//search, if null, doesnt exist, if nnot null, exists
	                ...
	                if(upObstaja == 0){
	                    ...
	                    JOptionPane.showMessageDialog(NovUporabnik.this, "Nov uporabnik je uspešno dodan.", "Dodan uporabnik.", JOptionPane.OK_OPTION);
	                    setVisible(false);
	                } else if (upObstaja != 0){
	                    JOptionPane.showMessageDialog(NovUporabnik.this, "Uporabnik že obstaja!", "Napaka pri iskanju.", JOptionPane.ERROR_MESSAGE);
	                } else{
	                    JOptionPane.showMessageDialog(NovUporabnik.this, "Vnesli ste napaèno besedo ali znak. Poskusite ponovno.");
	                }
	            }
	        });
